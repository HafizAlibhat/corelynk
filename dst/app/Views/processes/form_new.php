                            ...
                            <?php if (!empty($vendors)): ?>
                                <?php foreach ($vendors as $vendor): ?>
                                    <option value="<?= $vendor['id'] ?>" 
                                        ...
                                        <?= esc($vendor['name']) ?> - <?= esc($vendor['specialization']) ?>
                                    </option>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
            ...
            <div class="modal-body">
                <form id="newVendorForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="vendorSpecialization" class="form-label">Specialization</label>
                                <input type="text" class="form-control" id="vendorSpecialization" name="specialization">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
function createVendor() {
    ...
    .then(data => {
        if (data.success) {
            ...
            const vendorSelect = document.getElementById('vendor_id');
            const option = new Option(data.vendor.name + ' - ' + data.vendor.specialization, data.vendor.id, true, true);
