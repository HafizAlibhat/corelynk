...
class VendorModel extends Model
{
    ...
    {
        // Keep the vendor row ungrouped so this query works with ONLY_FULL_GROUP_BY.
        $builder = $this->select(
            'vendors.*, (SELECT COUNT(*) FROM processes WHERE processes.vendor_id = vendors.id) AS process_count',
            false
        );
