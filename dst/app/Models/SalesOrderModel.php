...
class SalesOrderModel extends Model
{
    ...
    protected $allowedFields = [
        'order_number','quotation_id','customer_id','order_date','subtotal','discount','document_discount_type','document_discount_value','discount_exclude_shipping','tax_total','total','status','customer_snapshot','created_by','public_id'
    ];
