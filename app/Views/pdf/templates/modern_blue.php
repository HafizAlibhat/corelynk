<?php
/**
 * Modern Blue PDF Template
 * Clean & minimal layout with blue accent colors
 */
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .company-name { font-size: 16px; font-weight: 700; color: #2563eb; margin-bottom: 4px; }
        .company-detail { font-size: 9px; color: #64748b; line-height: 1.4; }
        ...
        .doc-meta { font-size: 10px; opacity: 0.9; margin-top: 4px; }
        ...
        .customer-label { font-size: 8px; color: #64748b; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px; }
        .customer-name { font-size: 12px; font-weight: 700; color: #1e293b; margin-bottom: 3px; }
        .customer-info { font-size: 9px; color: #475569; line-height: 1.4; }
        ...
        .items .img-cell img { max-height: 30px; max-width: 30px; }
        
        /* Totals */
        .totals-wrap { width: 220px; margin-left: auto; margin-top: 10px; }
        .totals { width: 100%; border-collapse: collapse; }
        .totals td { padding: 5px 8px; font-size: 9px; }
        ...
        .totals .grand td { font-size: 11px; font-weight: 700; padding: 8px; }
...
<body>
    <div class="header">
        ...
        <div class="header-right">
            ...
            <?php foreach ($companyLines as $line): ?>
                <div class="company-detail"><?= esc($line) ?></div>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <div class="title-banner">
        ...
        <div class="doc-meta"><?= esc($documentNumberLabel) ?> <?= esc($invoiceNo) ?> &nbsp;|&nbsp; <?= esc($fmtDate($issueDate)) ?></div>
    </div>
    ...
    <div class="customer-box">
        ...
        <?php foreach ($customerLines as $line): ?>
            <div class="customer-info"><?= esc($line) ?></div>
        <?php endforeach; ?>
    </div>
    ...
    <table class="items">
        <thead>
            <tr>
                ...
                <?php if ($hasAnyDiscount): ?><th class="num" style="width:10%;">Disc</th><?php endif; ?>
